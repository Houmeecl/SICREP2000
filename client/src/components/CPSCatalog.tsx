...
export default function CPSCatalog() {
  ...
  const cpsItems: CPSItem[] = [
    { code: "CPS-2025-001", material: "HDPE", type: "Bidón 20L", weight: "850g", recyclability: 95, status: "active" },
    { code: "CPS-2025-002", material: "Cartón Corrugado", type: "Caja 60x40x30", weight: "1.2kg", recyclability: 88, status: "active" },
    { code: "CPS-2025-003", material: "PET", type: "Botella 2L", weight: "45g", recyclability: 92, status: "active" },
    { code: "CPS-2024-128", material: "PP", type: "Contenedor Industrial", weight: "2.5kg", recyclability: 78, status: "active" },
    { code: "CPS-2024-089", material: "Aluminio", type: "Lata 500ml", weight: "15g", recyclability: 98, status: "deprecated" },
  ];

  const filteredItems = cpsItems.filter(item => 
